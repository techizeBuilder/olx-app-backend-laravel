                                    ...
                                    <div class="row">
                                        ...
                                        @if($isDefault)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="slug" class="form-control" data-parsley-required="true" value="{{ $blog->slug ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @if($isDefault)
                                                    <select name="tags[]" data-tags="true" data-placeholder="{{__("Tags")}}" data-allow-clear="true" class="select2 col-12 w-100" multiple="multiple" data-parsley-required="true">
                                                        @foreach($tagsArr as $tag)
                                                            <option value="{{ $tag }}" selected>{{ $tag }}</option>
                                                        @endforeach
                                                    </select>
                                                @else
                                                    <select name="translations[{{ $lang->id }}][tags][]" data-tags="true" data-placeholder="{{__("Tags")}}" data-allow-clear="true" class="select2 col-12 w-100" multiple="multiple">
                                                        @foreach($tagsArr as $tag)
                                                            <option value="{{ $tag }}" selected>{{ $tag }}</option>
                                                        @endforeach
                                                    </select>
