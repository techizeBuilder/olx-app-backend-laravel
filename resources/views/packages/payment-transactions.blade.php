                            ...
                            <div class="col-12">
                                <table class="table table-borderless table-striped" aria-describedby="mydesc"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="order_id" data-visible="false" data-align="center" data-sortable="true">{{ __('Order Id') }}</th>
                                        <th scope="col" data-field="created_at" data-align="center" data-sortable="true">{{ __('Created At') }}</th>
                                        <th scope="col" data-field="operate" data-align="center" data-sortable="false" data-escape="false">{{ __('Action') }}</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
