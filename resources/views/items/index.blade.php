                            ...
                            <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                                ...
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col" data-field="user_profile" data-formatter="userProfileFormatter"> {{ __('User') }}</th>
                                        <th scope="col" data-field="price" data-sortable="true">{{ __('Price') }} </th>
                                        <th scope="col" data-field="min_salary" data-sortable="true" data-visible="false"> {{ __('Min Salary') }}</th>
                                        <th scope="col" data-field="max_salary" data-sortable="true" data-visible="false"> {{ __('Max Salary') }}</th>
                                        <th scope="col" data-field="category.name" data-sortable="true"> {{ __('Category') }}</th>
                                        <th scope="col" data-field="image" data-sortable="false" data-escape="false" data-formatter="itemImageFormatter"> {{ __('Image') }}</th>
                                        ...
                                        <th scope="col" data-field="address" data-sortable="true" data-filter-control="select" data-filter-data="" data-visible="true" data-formatter="addressFormatter"> {{ __('Address') }}</th>
                                        <th scope="col" data-field="featured_status" data-sortable="false" data-filter-control="select" data-filter-data="" data-formatter="featuredItemStatusFormatter"> {{ __('Featured or Not') }}</th>
                                        <th scope="col" data-field="status" data-sortable="false" data-escape="false" data-formatter="itemStatusFormatter"> {{ __('Status') }}</th>
                                        @can('advertisement-update')
                                        ...
                                        <th scope="col" data-field="created_at" data-sortable="true" data-visible="true" data-align="center"> {{ __('Created At') }}</th>
                                        <th scope="col" data-field="expiry_date" data-sortable="true" data-visible="true" data-align="center"> {{ __('Expiry Date') }}</th>
                                        ...
                                        <th scope="col" data-field="clicks" data-sortable="true" data-visible="true" data-align="center" data-formatter="clicksFormatter">{{ __('Clicks') }}</th>
                                        @canany(['advertisement-update', 'advertisement-delete'])
                                            <th scope="col" data-field="operate" data-sortable="false" data-events="itemEvents" data-escape="false"> {{ __('Action') }}</th>
                                        @endcanany
                                    </tr>
                                </thead>
                            </table>
