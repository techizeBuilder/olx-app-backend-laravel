...
@section('content')
    <section class="section">
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            ...
            <strong>{{ __('Note:') }}</strong> {{ __('For the Web version, ensure the language codes and default language code are also updated in the .env file') }}
            (<code>NEXT_PUBLIC_SUPPORTED_LANGS_CODE</code> {{ __('and') }} <code>NEXT_PUBLIC_DEFAULT_LANG_CODE</code>).
