...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('Create Advertisement')); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('advertisement.store')); ?>" class="create-form" data-parsley-validate
                    ...
                    <div class="tab-content pt-3">
                        ...
                        <div class="tab-pane fade" id="listing">
                            <div class="row mb-3">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <label class="form-label mb-1"><?php echo e(__('Selected category')); ?></label>
                                            <div id="selected-category-breadcrumb" class="text-primary"></div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <label class="me-2 mb-0"><?php echo e(__('Select Language')); ?>:</label>
                                            <select class="form-control form-control-sm" id="details-language-selector" style="width: 200px;">
                                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($lang->id); ?>" data-code="<?php echo e($lang->code); ?>" <?php echo e($lang->id == $defaultLanguage->id ? 'selected' : ''); ?>>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 language-fields default-language-fields" data-language-id="<?php echo e($defaultLanguage->id); ?>">
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                            <label><?php echo e(__('Title')); ?> <span class="text-danger">*</span></label>
                                    <input type="text" name="name" id="name-input" value="<?php echo e(old('name')); ?>"
                                                class="form-control" required placeholder="<?php echo e(__('Enter title')); ?>">
                                </div>

                                        <div class="col-12 mb-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <label><?php echo e(__('Description')); ?> <span class="text-danger">*</span></label>
                                                <?php if($geminiEnabled ?? false): ?>
                                                    <button type="button" class="btn btn-sm btn-outline-primary generate-description-btn">
                                                        <i class="fas fa-magic"></i> <?php echo e(__('Generate with AI')); ?>

                                                        <span class="spinner-border spinner-border-sm d-none description-loading"></span>
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                                            <textarea name="description" id="description-input" class="form-control" rows="5" required placeholder="<?php echo e(__('Enter description')); ?>"><?php echo e(old('description')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($lang->id != $defaultLanguage->id): ?>
                                        <div class="col-12 language-fields other-language-fields" data-language-id="<?php echo e($lang->id); ?>" style="display: none;">
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <label><?php echo e(__('Title')); ?></label>
                                                    <input type="text" name="translations[<?php echo e($lang->id); ?>][name]" 
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <textarea name="translations[<?php echo e($lang->id); ?>][description]" 
                                                        class="form-control translation-description" 
                                                        data-lang-id="<?php echo e($lang->id); ?>" rows="5"
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <select class="form-control select2" id="currency" name="currency_id" required>
                                        ...
                                        <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($currency->id); ?>" data-iso-code="<?php echo e($currency->iso_code ?? ''); ?>" data-symbol="<?php echo e($currency->symbol ?? ''); ?>"><?php echo e($currency->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 mb-3" id="price-field">
                                    ...
                                    <input type="number" name="price" id="price-input" value="<?php echo e(old('price')); ?>"
                                        class="form-control" required placeholder="<?php echo e(__('Enter price')); ?>">
                                </div>

                                <div class="col-12 mb-3" id="salary-fields" style="display: none;">
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                    <label><?php echo e(__('Min Salary')); ?></label>
                                            <input type="number" name="min_salary" id="min-salary-input" class="form-control"
                                                value="<?php echo e(old('min_salary')); ?>" placeholder="<?php echo e(__('Enter minimum salary')); ?>">
                                        </div>
                                        <div class="col-12">
                                    <label><?php echo e(__('Max Salary')); ?></label>
                                    <input type="number" name="max_salary" id="max-salary-input" class="form-control"
                                                value="<?php echo e(old('max_salary')); ?>" placeholder="<?php echo e(__('Enter maximum salary')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="tel" name="contact" id="contact-input"
                                        value="<?php echo e(old('contact', auth()->user()->phone ?? '')); ?>" class="form-control"
                                        placeholder="<?php echo e(__('Enter phone number')); ?>">
                                    <input type="hidden" name="country_code" id="country-code-input" value="<?php echo e(old('country_code', auth()->user()->country_code ?? '')); ?>">
                                    <input type="hidden" name="region_code" id="region-code-input" value="<?php echo e(old('region_code', auth()->user()->region_code ?? '')); ?>">
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" name="video_link" id="video_link" class="form-control"
                                        ...
                                        placeholder="<?php echo e(__('Enter video URL (e.g., https://www.youtube.com/watch?v=...)')); ?>">
                                </div>

                                <div class="col-12 mb-3">
                                    <label><?php echo e(__('Slug')); ?></label>
                                    <input type="text" name="slug" value="<?php echo e(old('slug')); ?>" class="form-control"
                                        placeholder="<?php echo e(__('Enter slug (optional)')); ?>">
                                </div>
                            </div>

                            <div class="mt-4 d-flex justify-content-between">
                                <button type="button" class="btn btn-primary btn-prev-tab"
                                    data-prev-tab="categories"><?php echo e(__('Previous')); ?></button>
                                <button type="button" class="btn btn-primary btn-next-tab"
                                    data-next-tab="custom-or-images"><?php echo e(__('Next')); ?></button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="categories">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h5 class="mb-0"><?php echo e(__('All Category')); ?></h5>
                                            <button type="button" class="btn btn-secondary btn-sm" id="go-back-category-btn" style="display: none;">
                                                <i class="fas fa-arrow-left me-1"></i><?php echo e(__('Go Back')); ?>
                        ...
                        <div class="tab-pane fade" id="custom">
                            <div class="text-muted"><?php echo e(__('Select a category to load custom fields.')); ?></div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="images">
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <label class="form-label">
                                        ...
                                        <i class="fas fa-info-circle" data-bs-toggle="tooltip" title="<?php echo e(__('Upload images for your advertisement. The first image will be highlighted and considered the main image.')); ?>"></i>
                                    ...
                                    <div class="upload-area" id="gallery-images-upload" 
                                        ...
                                        <p class="mb-2" style="color: #666;"><?php echo e(__('Drag & Drop your files')); ?></p>
                                        <p class="mb-3" style="color: #999;"><?php echo e(__('or')); ?></p>
                                        <button type="button" class="btn btn-primary" id="gallery-images-btn" style="background: #20c997; border: none;">
                                            <i class="fas fa-upload me-2"></i><?php echo e(__('Upload')); ?>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <button type="button" class="btn btn-primary btn-prev-tab"
                                    data-prev-tab="custom-or-images"><?php echo e(__('Previous')); ?></button>
                                <button type="button" class="btn btn-primary btn-next-tab"
                                    data-next-tab="address"><?php echo e(__('Next')); ?></button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="address">
                            <div class="row">
                                <div class="col-12">
                                    <label class="form-label mb-2"><?php echo e(__('Map Address')); ?></label>
                                    ...
                                    <div class="d-flex gap-2 mb-3" style="position: relative; z-index: 1000;">
                                        <div class="flex-grow-1 position-relative" style="z-index: 1001;">
                                            ...
                                            <input type="text" id="location-search" class="form-control ps-5" 
                                                   placeholder="<?php echo e(__('Select Location')); ?>" 
                                        ...
                                        <button type="button" class="btn btn-primary" id="locate-me-btn" 
                                            ...
                                            <i class="fas fa-crosshairs me-2"></i><?php echo e(__('Locate me')); ?>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1"><?php echo e(__('Address')); ?></h6>
                                    ...
                                    <?php if(($mapProvider ?? 'free_api') === 'free_api'): ?>
                                    <div class="text-center mb-3">
                                        <p class="text-muted mb-2"><?php echo e(__('Or')); ?></p>
                                        <p class="mb-2"><?php echo e(__('What Is the Location Of the Advertisement You Are Selling')); ?></p>
                                        <button type="button" class="btn btn-primary" id="add-location-btn" data-bs-toggle="modal" data-bs-target="#manualLocationModal"><?php echo e(__('Add Location')); ?></button>
                                    </div>
                                    <?php endif; ?>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <button type="button" class="btn btn-primary btn-prev-tab"
                                    data-prev-tab="images"><?php echo e(__('Previous')); ?></button>
                                <button type="button" class="btn btn-primary btn-next-tab"
                                    data-next-tab="seo"><?php echo e(__('Next')); ?></button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="seo">
                            <div class="row mb-3">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h5><?php echo e(__('SEO Details')); ?></h5>
                                        <div class="d-flex align-items-center gap-2">
                                            <?php if($geminiEnabled ?? false): ?>
                                                <button type="button" class="btn btn-sm btn-outline-primary" id="generate-meta-btn">
                                                    <i class="fas fa-magic"></i> <?php echo e(__('Generate SEO with AI')); ?>
                                            ...
                                            <select class="form-control form-control-sm" id="seo-language-selector" style="width: 200px;">
                                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($lang->id); ?>" <?php echo e($lang->id == $defaultLanguage->id ? 'selected' : ''); ?>>
                                                        <?php echo e($lang->name); ?>
                            ...
                            <div class="seo-language-fields" data-seo-language-id="<?php echo e($defaultLanguage->id); ?>">
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <label><?php echo e(__('Meta Title')); ?></label>
                                        <input type="text" name="meta_title[<?php echo e($defaultLanguage->id); ?>]" class="form-control" placeholder="<?php echo e(__('Enter meta title')); ?>">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label><?php echo e(__('Meta Description')); ?></label>
                                        <textarea name="meta_description[<?php echo e($defaultLanguage->id); ?>]" class="form-control" rows="3" placeholder="<?php echo e(__('Enter meta description')); ?>"></textarea>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label><?php echo e(__('Meta Keywords')); ?></label>
                                        <textarea name="meta_keywords[<?php echo e($defaultLanguage->id); ?>]" class="form-control" rows="2" placeholder="<?php echo e(__('Enter meta keywords')); ?>"></textarea>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label><?php echo e(__('Schema')); ?></label>
                                        <textarea name="schema[<?php echo e($defaultLanguage->id); ?>]" class="form-control" rows="4" placeholder='{"@context": "https://schema.org", ...}'></textarea>
                                        <small class="text-muted d-block mt-1">
                                            <i class="fas fa-info-circle"></i>
                                            <?php echo e(__('Schema is not auto-generated by AI. Please add it manually after saving the item, when image URLs and other required data are available.')); ?>
                            ...
                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($lang->id != $defaultLanguage->id): ?>
                                    <div class="seo-language-fields" data-seo-language-id="<?php echo e($lang->id); ?>" style="display: none;">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <label><?php echo e(__('Meta Title')); ?> (<?php echo e($lang->name); ?>)</label>
                                                <input type="text" name="meta_title[<?php echo e($lang->id); ?>]" class="form-control" placeholder="<?php echo e(__('Enter meta title')); ?>">
                                            </div>
                                            <div class="col-12 mb-3">
                                                <label><?php echo e(__('Meta Description')); ?> (<?php echo e($lang->name); ?>)</label>
                                                <textarea name="meta_description[<?php echo e($lang->id); ?>]" class="form-control" rows="3" placeholder="<?php echo e(__('Enter meta description')); ?>"></textarea>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <label><?php echo e(__('Meta Keywords')); ?> (<?php echo e($lang->name); ?>)</label>
                                                <textarea name="meta_keywords[<?php echo e($lang->id); ?>]" class="form-control" rows="2" placeholder="<?php echo e(__('Enter meta keywords')); ?>"></textarea>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <label><?php echo e(__('Schema')); ?> (<?php echo e($lang->name); ?>)</label>
                                                <textarea name="schema[<?php echo e($lang->id); ?>]" class="form-control" rows="4" placeholder='{"@context": "https://schema.org", ...}'></textarea>
                                                <small class="text-muted d-block mt-1">
                                                    <i class="fas fa-info-circle"></i>
                                                    <?php echo e(__('Schema is not auto-generated by AI. Please add it manually after saving the item, when image URLs and other required data are available.')); ?>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <button type="button" class="btn btn-primary btn-prev-tab"
                                    data-prev-tab="address"><?php echo e(__('Previous')); ?></button>
                                <button type="submit" class="btn btn-primary"><?php echo e(__('Post')); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="manualLocationModalLabel"><?php echo e(__('Manually Add Location')); ?></h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <select class="form-select" id="manual-country-select">
                            ...
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($country->id); ?>" data-name="<?php echo e($country->name); ?>" data-lat="<?php echo e($country->latitude); ?>" data-lng="<?php echo e($country->longitude); ?>"><?php echo e($country->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <textarea class="form-control" id="manual-address-input" rows="3" placeholder="<?php echo e(__('Enter address')); ?>"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
                    <button type="button" class="btn btn-primary" id="manual-location-save"><?php echo e(__('Save')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <!-- intl-tel-input CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/extensions/intl-tel-input/css/intlTelInput.css')); ?>">
    <!-- intl-tel-input JS -->
    <script src="<?php echo e(asset('assets/extensions/intl-tel-input/js/intlTelInput.min.js')); ?>"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            const defaultLanguageId = <?php echo e($defaultLanguage->id); ?>;
            ...
            $('#details-language-selector').on('change', function() {
                ...
                const defaultLangId = <?php echo e($defaultLanguage->id); ?>;
            ...
            function initPhoneInput() {
                ...
                try {
                    const iti = window.intlTelInput(phoneInput, {
                        initialCountry: "<?php echo e($userInitialCountry); ?>",
                        preferredCountries: ['us', 'gb', 'in', 'ca', 'au'],
                        separateDialCode: true,
                        utilsScript: "<?php echo e(asset('assets/extensions/intl-tel-input/js/utils.js')); ?>"
                    });
            ...
            function loadCategories(parentId, page = 1) {
                const url = parentId ?
                    '<?php echo e(route('advertisement.get-subcategories')); ?>' :
                    '<?php echo e(route('advertisement.get-parent-categories')); ?>';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        html += `<div class="row mb-3">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="mb-0"><?php echo e(__('Extra Details')); ?></h5>
                                    <div class="d-flex align-items-center">
                                        <label class="me-2 mb-0"><?php echo e(__('Select Language')); ?>:</label>
                        ...
                        <button type="button" class="btn btn-primary btn-prev-tab" data-prev-tab="listing"><?php echo e(__('Previous')); ?></button>
                        <button type="button" class="btn btn-primary btn-next-tab" data-next-tab="images"><?php echo e(__('Next')); ?></button>
                    </div>`;
                            $('#custom-tab-item').hide();
                        ...
                        if (isJobCategory) {
                            ...
                            if (isPriceOptional) {
                                ...
                                $('#salary-fields label').first().html('<?php echo e(__('Min Salary')); ?> <span class="text-danger">*</span>');
                                $('#salary-fields label').last().html('<?php echo e(__('Max Salary')); ?> <span class="text-danger">*</span>');
                            ...
                            if (isPriceOptional) {
                                ...
                                $('#price-field label').html('<?php echo e(__('Price')); ?>');
                                $('#price-input').removeAttr('required');
                            } else {
                                // Price not optional: make required
                                $('#price-field label').html('<?php echo e(__('Price')); ?> <span class="text-danger">*</span>');
        ...
        function searchLocation(query) {
            ...
            searchTimeout = setTimeout(function() {
                $.ajax({
                    url: '<?php echo e(url("api/get-location")); ?>',
                    type: 'GET',
                    data: {
                        search: query,
                    ...
                    headers: {
                        'Content-Language': '<?php echo e(app()->getLocale()); ?>'
                    },
                    success: function(response) {
        ...
        $(document).ready(function() {
            ...
            $('.generate-description-btn').on('click', function() {
                ...
                if (!title) {
                    Toastify({ text: '<?php echo e(__("Please enter a title first")); ?>', duration: 3000, close: true, backgroundColor: '#dc3545' }).showToast();
                    return;
                }
                ...
                $.ajax({
                    url: '<?php echo e(route("gemini.generate-description")); ?>',
                    method: 'POST',
                    ...
                    success: function(response) {
                        if (!response.error && response.data) {
                            ...
                            Toastify({ text: '<?php echo e(__("Description generated successfully")); ?>', duration: 3000, close: true, backgroundColor: 'linear-gradient(to right, #00b09b, #96c93d)' }).showToast();
                        } else {
                            Toastify({ text: response.message || '<?php echo e(__("Failed to generate description")); ?>', duration: 3000, close: true, backgroundColor: '#dc3545' }).showToast();
                        }
                    },
                    error: function(xhr) {
                        Toastify({ text: xhr.responseJSON?.message || '<?php echo e(__("An error occurred")); ?>', duration: 3000, close: true, backgroundColor: '#dc3545' }).showToast();
                    },
                    complete: function() {
            ...
            $('#generate-meta-btn').on('click', function() {
                ...
                if (!title || !title.trim() || !description || !description.trim()) {
                    Toastify({ text: '<?php echo e(__("Please enter title and description for the selected language first")); ?>', duration: 3000, close: true, backgroundColor: '#dc3545' }).showToast();
                    return;
                }
                ...
                $.ajax({
                    url: '<?php echo e(route("gemini.generate-meta")); ?>',
                    method: 'POST',
                    headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
                        title: title,
                    ...
                    success: function(response) {
                        if (!response.error && response.data) {
                            ...
                            Toastify({ text: '<?php echo e(__("SEO details generated successfully")); ?>', duration: 3000, close: true, backgroundColor: 'linear-gradient(to right, #00b09b, #96c93d)' }).showToast();
                        } else {
                            Toastify({ text: response.message || '<?php echo e(__("Failed to generate SEO details")); ?>', duration: 3000, close: true, backgroundColor: '#dc3545' }).showToast();
                        }
                    },
                    error: function(xhr) {
                        Toastify({ text: xhr.responseJSON?.message || '<?php echo e(__("An error occurred")); ?>', duration: 3000, close: true, backgroundColor: '#dc3545' }).showToast();
        ...
        $(document).ready(function() {
            ...
            $modal.on('shown.bs.modal', function() {
                initSelect2($country, '<?php echo e(__('Country')); ?>');
                initSelect2($state, '<?php echo e(__('State')); ?>');
                initSelect2($city, '<?php echo e(__('City')); ?>');
            });
            ...
            $country.on('change', function() {
                ...
                resetSelect($state, '<?php echo e(__('State')); ?>');
                resetSelect($city, '<?php echo e(__('City')); ?>');
                if (!countryId) return;
                $.ajax({
                    url: '<?php echo e(url('api/states')); ?>',
            ...
            $('#manual-location-save').on('click', function() {
                ...
                if (!countryName) {
                    showErrorToast('<?php echo e(__('Please select a country')); ?>');
                    return;
                }
                if (!stateName) {
                    showErrorToast('<?php echo e(__('Please select a state')); ?>');
                    return;
                }
                if (!cityName) {
                    showErrorToast('<?php echo e(__('Please select a city')); ?>');
                    return;
                }
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\OLX\resources\views/items/create.blade.php ENDPATH**/ ?>