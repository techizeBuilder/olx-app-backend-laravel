                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 h-100 px-2 pb-3 pb-md-0">
                                ...
                                <div id="chats-list" class="flex-grow-1 chat-scrollable chat-scroll-hide">
                                    <div class="text-center p-4 mt-5">
                                        <img src="<?php echo e(asset('assets/images/chats/chat-section-emtpy.png')); ?>" alt="<?php echo e(__('No Chat Found')); ?>" class="admin-chat-empty-icon">
                                        <h5 class="admin-chat-empty-title"><?php echo e(__('No Chat Found')); ?></h5>
                                        <p class="text-muted admin-chat-empty-subtitle"><?php echo e(__("It Look's Like there is no Chat Available")); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="p-3 border-top flex-shrink-0" id="chat-input-container">
                                    <form id="send-message-form">
                                        <div class="input-group chat-compose-group">
                                            ...
                                            <input type="text" class="form-control" id="message-input" placeholder="<?php echo e(__('Type Messages')); ?>" required>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\OLX\resources\views/admin-chat/index.blade.php ENDPATH**/ ?>