        ...
        $(document).ready(function() {
            ...
            $('#btn-clear-filters').on('click', function() {
                ...
                $('#filter_state_item, #filter_city_item')
                    .html('<option value=""><?php echo e(__('All')); ?></option>');
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\OLX\resources\views/items/index.blade.php ENDPATH**/ ?>